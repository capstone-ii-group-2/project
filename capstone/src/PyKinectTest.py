# READ THE README.md
# basically none of the code in here is from me, I just followed the example available on the PyKinect github page
# we should discuss replacing this with our own code and probably look at how the other sign language kinect program worked
import ctypes
import _ctypes
import pygame
import sys
...
def run():
    ...
    print('trying to do things with pykinect2')
